...
class RecipeController extends Controller
{
    ...
    public function randomJoke(){
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => "https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/food/jokes/random",
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => "",
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 30,
    ...
    public function randomFact(){
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => "https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/food/trivia/random",
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => "",
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 30,
